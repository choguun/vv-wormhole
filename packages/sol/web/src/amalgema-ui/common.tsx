...
export function PercentageInput({
  ...
  return (
    <div className="relative w-full">
      <input
        className={twMerge(
          "w-full bg-ss-bg-2 px-4 py-2 border border-[#DDDAD0]",
          className
        )}
        type="text"
        value={Number(amount)}
...
export function ReadOnlyTextInput({
  ...
  return (
    <div className="relative w-full">
      ...
      <span className={twMerge("absolute right-3 top-[8px]", symbolClassName)}>
        {symbol}
      </span>
    </div>
  );
...
export function LabeledOrbInput({
  ...
  return (
    <div className="flex flex-row items-baseline w-full h-[36px] bg-ss-bg-2 px-4 py-1 border border-[#DDDAD0] align-middle">
      ...
      <input
        className={twMerge(
          " w-[100px] align-middle	shrink text-right pr-3 bg-ss-bg-2",
          className
        )}
        type="text"
        readOnly
...
export function EthInput({
  ...
  return (
    ...
    >
      ...
      <Body className="text-ss-text-default right-3">{NATIVE_SYMBOL}</Body>
    </div>
  );
}
